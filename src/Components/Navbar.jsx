          ...
          <NavLink to="/">
            <div className="flex items-center gap-1 cursor-pointer">
              <img
                ...
                alt="logo"
              />
              <h1 className="hidden lg:flex font-bold text-2xl text-transparent bg-clip-text bg-linear-to-r from-green-600 to-teal-800">
                {" "}
                Green Event
              </h1>
            </div>
          ...
          {user ? (
            <div className="dropdown dropdown-bottom dropdown-end dropdown-hover">
              ...
              >
                ...
                <li>
                  <Link to="/my-joined-events">Join Events</Link>
                </li>
                <li>
                  <a>Profile</a>
                </li>
